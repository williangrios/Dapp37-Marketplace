  ...
  <div className="p-8">
    ...
    <div className="flex justify-between items-center">
      <div className="sm:flex sm:justify-center lg:justify-start">
        <Button className="mr-2 text-sm xs:text-lg p-2" variant="white">Learn how to purchase</Button>
      </div>
      <div>
        { (!network.isSupported && network.data) &&
          <div className="bg-red-400 p-4 rounded-lg">
          <div>
            Your are connected to wrong network
          </div>
          <div>
            Connect to: <strong className="text-2xl">{network.target}</strong>
          </div>
